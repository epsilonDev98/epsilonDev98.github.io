...
$( document ).ready(function() {
  ...
  $(".round1").on("click",function(){
     $(".tl-round").css("background-color","#18d26e");
     $(".round1").css("background-color","#3498db");
  ...
  $(".round2").on("click",function(){
     $(".tl-round").css("background-color","#18d26e");
     $(".round1").css("background-color","#3498db");
     $(".round2").css("background-color","#3498db");
  ...
  $(".round3").on("click",function(){
     ...
     $(".round1").css("background-color","#3498db");
     $(".round2").css("background-color","#3498db");
     $(".round3").css("background-color","#3498db");
  ...
  $(".round4").on("click",function(){
     ...
     $(".round2").css("background-color","#3498db");
     $(".round3").css("background-color","#3498db");
     $(".round4").css("background-color","#3498db");
